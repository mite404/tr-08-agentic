 ...
 *
 * Simple authentication UI that allows users to sign in with Google or GitHub.
 * Displays user info when authenticated with a sign-out option.
 *
 * Props:
...
export function LoginModal({
  ...
  if (loading) {
    return (
      <div className="flex items-center gap-2 rounded bg-gray-800 px-4 py-2 text-sm text-gray-300">
        <span>Loading...</span>
      </div>
    );
  }
  ...
  if (session?.user) {
    return (
      <div className="flex items-center gap-3 rounded bg-gray-800 px-4 py-2">
